...
Here is a script you can use if you would prefer to have all the code
for the QC plot step in a single script rather than an installable
package format. Just click the clipboard icon in the top right corner of
this code chunk to copy the code, then open a new R script in RStudio
and paste it there, and save the script wherever you would like to store
it on your computer.
...
## Demo using `dataQCtools::make_qc_plots_of_cropped_data()`
